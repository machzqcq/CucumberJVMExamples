...
# cucumber-jvm-selenium-class8

Explains how parse excel workbooks and read and use the values on web form  .
...
- `./mvnw clean test -Dcucumber.features="classpath:features/ApachePOIExcel.feature"`
- `./mvnw clean test -Dcucumber.features="classpath:features/ApachePOIExcel.feature:11"`
- `./mvnw clean test -Dcucumber.features="classpath:features/ApachePOIExcel.feature" -Dcucumber.plugin="html:target/cucumber-html-report.html, json:target/cucumber.json"`

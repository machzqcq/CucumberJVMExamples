# cucumberjvm-selenium-keyword-framework

A barebone example for creating a keyword driven framework
...
Git:
    ...
    cd cucumberjvm-selenium-keyword-framework
...
- `./mvnw clean test -Dcucumber.features="classpath:features/KeywordDrivenFramework.feature"`
- `./mvnw clean test -Dcucumber.features="classpath:features/KeywordDrivenFramework.feature:11"`
- `./mvnw clean test -Dcucumber.features="classpath:features/KeywordDrivenFramework.feature" -Dcucumber.plugin="html:target/cucumber-html-report.html, json:target/cucumber.json"`

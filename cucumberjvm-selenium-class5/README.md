...
- `./mvnw clean test -Dcucumber.features="classpath:features/SwitchCommands.feature"`
- `./mvnw clean test -Dcucumber.features="classpath:features/SwitchCommands.feature:11"`
- `./mvnw clean test -Dcucumber.features="classpath:features/SwitchCommands.feature" -Dcucumber.plugin="html:target/cucumber-html-report.html, json:target/cucumber.json"`

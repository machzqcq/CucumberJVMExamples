...
- `./mvnw clean test -Dcucumber.features="classpath:features/SubmitForm.feature" -DBROWSER=chrome` - Notice that we are passing environment variable BROWSER
- `./mvnw clean test -Dcucumber.features="classpath:features/SubmitForm.feature:11" -DBROWSER=chrome`
- `./mvnw clean test -DBROWSER=chrome -Dcucumber.features="classpath:features/SubmitForm.feature" -Dcucumber.plugin="html:target/cucumber-html-report.html, json:target/cucumber.json"`
